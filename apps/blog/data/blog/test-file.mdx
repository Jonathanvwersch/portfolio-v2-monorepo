...
lastmod: '2024-08-31'
draft: false
summary: 'Lessons learned from building a scaleable frontend monorepo with Typescript, Turbo and Tsup'
images: ['/static/images/twitter-card.png']
---

## Introduction

The goal of this post is not to explain what a monorepo is or why you should opt into using one; there are plenty of good articles on the Internet already that go over that topic. Instead my goal here is to present my learnings from building out a good (if I do say so myself) monorepo system using tried and tested tooling in the form of tsup and Turbo.
