...
const marathons = [
  {
    ...
    description:
      'My first marathon. I was aiming for a sub-three hour time, but hit a wall at around 32km. With more training and experience, I believe a sub-three is within reach.',
  },
  {
    ...
    description:
      'First competitive race since recovering from a torn ACL. Not as quick as my last, but I deliberately took a more conservative approach in training to see how my new ACL would hold up. Fortunately, there were not issues so I think I can push myself harder next time.',
  },
];
    ...
    <>
      ...
      <div className="mb-8">
        ...
        <div className="flex flex-col space-y-6">
          {activeTab === 'marathons' &&
            marathons.map((race) => <RaceCard key={race.raceName} {...race} />)}
          {activeTab === 'half-marathons' &&
            halfMarathons.map((race) => <RaceCard key={race.raceName} {...race} />)}
        </div>
      </div>
    </>
  );
